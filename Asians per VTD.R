...
asian <- get_decennial(geography = "voting district", state='ny', variables = c("P1_001N","P1_006N"), 
...
asian %>% 
  ...
  mutate(asian_per = P1_006N/P1_001N) %>%
  ...
  labs(
    title = str_c('<span style="color: gray20; font-size: 35pt;">How Asians Voted in the NY 2020 Elections</span><br />
